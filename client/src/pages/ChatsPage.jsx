...
const ChatRoom = ({userID, setUserID, userName, setUserName, socket, setUserNameAlreadySelected, usernameAlreadySelected, users, setUsers, currentChat, setCurrentChat}) => {
